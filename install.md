...
Expand-Archive ".\PStodoist-$Version.zip" -DestinationPath ".\PStodoist-$Version"
...
Copy-Item ".\PSTodoist-$Version\*\Release\PSTodoist\*" -Destination "$ModulePath\PSTodoist\" -Recurse -Force
```
